function renderNeuroSync() {
    return `
        ...
        <!-- Legend -->
        <div style="display: flex; gap: 15px; margin-top: 20px; justify-content: center; flex-wrap: wrap; text-transform: uppercase; font-weight: 600; letter-spacing: 0.05em;">
            <div style="display: flex; align-items: center; gap: 8px;"><div style="width: 14px; height: 14px; border-radius: 4px; background: rgba(16,185,129,0.8); box-shadow: 0 0 10px rgba(16,185,129,0.5);"></div> <span style="font-size: 0.8rem; color: #ddd;">Zirve (Başarı)</span></div>
            <div style="display: flex; align-items: center; gap: 8px;"><div style="width: 14px; height: 14px; border-radius: 4px; background: rgba(59,130,246,0.8); box-shadow: 0 0 10px rgba(59,130,246,0.5);"></div> <span style="font-size: 0.8rem; color: #ddd;">Saha / Toplantı</span></div>
            <div style="display: flex; align-items: center; gap: 8px;"><div style="width: 14px; height: 14px; border-radius: 4px; background: rgba(245,158,11,0.8); box-shadow: 0 0 10px rgba(245,158,11,0.5);"></div> <span style="font-size: 0.8rem; color: #ddd;">Finans / Tahsilat</span></div>
            <div style="display: flex; align-items: center; gap: 8px;"><div style="width: 14px; height: 14px; border-radius: 4px; background: rgba(6,182,212,0.8); box-shadow: 0 0 10px rgba(6,182,212,0.5);"></div> <span style="font-size: 0.8rem; color: #ddd;">Vizyon / Eğitim</span></div>
            <div style="display: flex; align-items: center; gap: 8px;"><div style="width: 14px; height: 14px; border-radius: 4px; background: rgba(168,85,247,0.8); box-shadow: 0 0 10px rgba(168,85,247,0.5);"></div> <span style="font-size: 0.8rem; color: #ddd;">Ar-Ge</span></div>
            <div style="display: flex; align-items: center; gap: 8px;"><div style="width: 14px; height: 14px; border-radius: 4px; background: rgba(249,115,22,0.8); box-shadow: 0 0 10px rgba(249,115,22,0.5);"></div> <span style="font-size: 0.8rem; color: #ddd;">Kriz (Servis)</span></div>
            <div style="display: flex; align-items: center; gap: 8px;"><div style="width: 14px; height: 14px; border-radius: 4px; background: rgba(239,68,68,0.8); box-shadow: 0 0 10px rgba(239,68,68,0.5);"></div> <span style="font-size: 0.8rem; color: #ddd;">Eksik</span></div>
        </div>
        ...
        <div id="neuroModal" class="modal-overlay" style="display: none; align-items: center; justify-content: center; z-index: 9999;">
            <div class="card" style="width: 320px; padding: 30px; border-radius: 24px; box-shadow: 0 24px 50px rgba(0,0,0,0.5); border: 1px solid rgba(255,255,255,0.1); max-height: 90vh; overflow-y: auto;">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <button class="btn" style="background: rgba(59,130,246,0.15); color: #3B82F6; border: 1px solid rgba(59,130,246,0.3); border-radius: 12px; padding: 14px; font-weight: 600; text-align: left;" onclick="setNeuroColor('rgba(59,130,246,0.7)', 'Saha')">🔵 Saha / Toplantı Müzakere</button>
                    <button class="btn" style="background: rgba(245,158,11,0.15); color: #F59E0B; border: 1px solid rgba(245,158,11,0.3); border-radius: 12px; padding: 14px; font-weight: 600; text-align: left;" onclick="setNeuroColor('rgba(245,158,11,0.7)', 'Finans')">🟡 Finans / Tahsilat Günü</button>
                    <button class="btn" style="background: rgba(6,182,212,0.15); color: #06B6D4; border: 1px solid rgba(6,182,212,0.3); border-radius: 12px; padding: 14px; font-weight: 600; text-align: left;" onclick="setNeuroColor('rgba(6,182,212,0.7)', 'Vizyon')">🩵 Vizyon / Eğitim & Araştırma</button>
                    <button class="btn" style="background: rgba(168,85,247,0.15); color: #B39DFF; border: 1px solid rgba(168,85,247,0.3); border-radius: 12px; padding: 14px; font-weight: 600; text-align: left;" onclick="setNeuroColor('rgba(168,85,247,0.7)', 'Ar-Ge')">🟣 Derin Operasyon / Ar-Ge</button>
                    <button class="btn" style="background: rgba(249,115,22,0.15); color: #F97316; border: 1px solid rgba(249,115,22,0.3); border-radius: 12px; padding: 14px; font-weight: 600; text-align: left;" onclick="setNeuroColor('rgba(249,115,22,0.7)', 'Kriz')">🟠 Kriz / Teknik Servis Acil</button>
                    <button class="btn" style="background: rgba(239,68,68,0.15); color: #EF4444; border: 1px solid rgba(239,68,68,0.3); border-radius: 12px; padding: 14px; font-weight: 600; text-align: left;" onclick="setNeuroColor('rgba(239,68,68,0.7)', 'Eksik')">🔴 Kesinti / Verimsiz Gün</button>
